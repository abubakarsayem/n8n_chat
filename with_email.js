...
// Handle book a call button click
    function handleBookCallClick() {
        // Send the predefined message
        submitMessage("I want to book a meeting");
        
        // Hide the button
        bookCallButton.classList.add('hidden');
    }

    // Event listeners
    startChatButton.addEventListener('click', startChat);
    bookCallButton.addEventListener('click', handleBookCallClick);
